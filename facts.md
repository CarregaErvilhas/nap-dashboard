...
Ocupação instantânea: 2.866 em carregamento de 15.548 ativos (18%). AC lento o mais ocupado: 25,4% vs DC fast 50-150 kW 15,9%.
Dispersão por operador: ocupação de 3,6% (DTE, Instalacoes Especiais) a 35,1% (Maksu) — sinal de desfasamento oferta/procura por rede.
...
Saúde da rede no snapshot: 3.005 pontos 'removed' (14%), 988 'outOfOrder' (5%), 1.280 'unknown' (6%) → ≈25% não utilizável nesse momento.
