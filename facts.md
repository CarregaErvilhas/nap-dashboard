...
Ocupação instantânea: 2.489 em carregamento de 15.507 ativos (16%). AC lento o mais ocupado: 20,9% vs DC fast 50-150 kW 13,8%.
Dispersão por operador: ocupação de 3,6% (DTE, Instalacoes Especiais) a 27,1% (Maksu) — sinal de desfasamento oferta/procura por rede.
...
Saúde da rede no snapshot: 3.011 pontos 'removed' (14%), 1.077 'outOfOrder' (5%), 1.305 'unknown' (6%) → ≈26% não utilizável nesse momento.
...
Validação cruzada: potência NAP vs MOBI.E concorda em 99,9% dos pontos (só 28 divergem >30%) — boa notícia para a fiabilidade geral.
